...
class GenrateShortVideoFrompath extends StatefulWidget {
  final String path;

  GenrateShortVideoFrompath(this.path);

  @override
  _GenrateShortVideoFrompathState createState() =>
      _GenrateShortVideoFrompathState();
}

class _GenrateShortVideoFrompathState extends State<GenrateShortVideoFrompath> {
  var uint8list;
  bool loading = true;
  bool _like = false;
